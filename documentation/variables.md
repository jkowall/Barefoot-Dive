...
| --- | --- | --- | --- | --- |
| `package.json` version (`0.5.1`) | Vite build, Settings/footer display, and web/source release metadata | Client | Repository release edit; change for an app release | Stale release identification if package and documentation diverge |
